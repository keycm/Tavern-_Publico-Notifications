...
<footer class="main-footer" style="background-color: #1a1a1a; color: #bbb; padding: clamp(2rem, 8vw, 4rem) 0;">
    <div class="container footer-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: clamp(1.5rem, 5vw, 2.5rem); align-items: start;">
        ...
        <div class="footer-contact">
            ...
            <p style="font-family: 'Mada', sans-serif; margin-bottom: 10px; line-height: 1.6; font-size: 0.95em; font-weight: 400;">269 Floridablanca Road, Jose Abad Santos(Siran,Guagua,Pampnga</p>
            <p style="font-family: 'Mada', sans-serif; margin-bottom: 10px; line-height: 1.6; font-size: 0.95em; font-weight: 400;">Tavernpublico@gmail.com</p>

        </div>
        <div class="footer-hours">
            <h3 style="font-family: 'Mada', sans-serif; color: #fff; margin-bottom: 25px; font-weight: 600; line-height: 1.2; font-size: clamp(1.1rem, 2vw, 1.2rem);">Open Daily</h3>
            <p style="font-family: 'Mada', sans-serif; margin-bottom: 10px; line-height: 1.6; font-size: 0.95em; font-weight: 400;">Monday - Sunday: 11:00 AM - 9:00 PM</p>
